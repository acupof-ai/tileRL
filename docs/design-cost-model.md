...
(including load_hf's bf16→fp4 packing under cfg.fp4); without it all linears take the
config's nvfp4 face. The 27B checkpoint is mixed (264 nvfp4 / 233 fp8), so the
checkpoint-priced tick is 22.36/25.64 GB at B=1/B=8 against 14.88/18.16 GB all-nvfp4.
