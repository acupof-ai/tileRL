...
| [the rollouts grew into the cap](errors/2026-09-06-the-rollouts-grew-into-the-cap.md) | `src/tilerl/cli.py` `_refuse_short_rollouts` | check the rollout mean against the cap every N steps, not once before step 1; the number is already in the step line |
