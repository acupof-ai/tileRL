...
That entry also pins the 314-vs-315 block cause: the captured decode graph
reserves one pad slot+block, so pool num_blocks is one more than usable_blocks.
