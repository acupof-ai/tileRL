...
> Status: **CPU gates green; the sparse tick is WRAPPED and captured when
> sparse is on — sparse itself is opt-in since #558 (`--sparse-k N`); cuda
> capture + ms pending the sm90 card run.** #537 made
