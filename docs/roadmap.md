...
| Speculation | correct, 1.87 committed tokens per trunk forward; **loses 4.9× on H20 because a draft disables graph capture**. On sm70 the draft is in-graph: 5.53 ms = 25% of a depth-3 tick, spec 49.7 tok/s at 1024 vs dense 37.6 | CHANGELOG 2026-08-29 verdict, `wins/2026-09-02-draft-is-two-thirds-of-a-spec-tick.md` |
