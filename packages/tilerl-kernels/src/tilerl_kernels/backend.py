...
#: widest query run paged_attention treats as a decode chain
...
class Backend:
    ...
    def paged_attention(
        ...
        # the split-KV tile holds the whole GQA group at every chain position, so
        # a verify width rides the decode path as long as the group still fits
