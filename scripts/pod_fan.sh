...
for cmd in "$@"; do
  ...
  script+="export TILELANG_CACHE_DIR=/work/tilelang_cache PYTHONPATH=$REMOTE_DIR/src:$REMOTE_DIR/packages/tilerl-kernels/src TILERL_TARGET=cuda REMOTE_DIR=$REMOTE_DIR"$'\n'
