...
# A ratchet, not a constant. Eight modules carry an asserting block today
# (tensor_parallel's moved to tests/test_tensor_parallel.py on 2026-09-14 to
# break the model<->tensor_parallel import cycle); if one
